...
var ElencoTappe = new Vue({
  ...
  methods: {
    ...
    retrieveData(id) {
      console.log(
        `fetch http://localhost:8080/BilleMatteoProgettoEsame/api/viaggi/${id}`
      );
      let response = fetch(
    ...
    setTappe(){
      ...
      console.log(this.viaggio.features[0].geometry.coordinates);
      this.tappe=this.viaggio.features[0].geometry.coordinates;
